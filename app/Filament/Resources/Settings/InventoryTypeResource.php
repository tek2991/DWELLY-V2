...
class InventoryTypeResource extends Resource
{
    ...
    protected static ?string $modelLabel = 'Inventory Type';
    protected static ?string $pluralModelLabel = 'Inventory Types';
    ...
    {
        return [
            'index' => \App\Filament\Resources\Settings\InventoryTypeResource\Pages\ManageInventoryTypes::route('/'),
        ];
    }
}
